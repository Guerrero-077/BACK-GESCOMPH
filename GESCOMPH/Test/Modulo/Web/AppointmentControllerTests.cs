...
public class AppointmentControllerTests
{
    ...
    public async Task Create_ReturnsOk()
    {
        ...
        var ctrl = new AppointmentController(_svc.Object);
        var res = await ctrl.Create(new Entity.DTOs.Implements.Business.Appointment.AppointmentCreateDto { FirstName = "A", LastName = "B", Document = "1", Address = "X", Phone = "Y", EstablishmentId = 1, Description = "D", RequestDate = DateTime.UtcNow });
